...
public class Exercise1Test extends ClassicOnlineStore {
    ...
    public void whoHaveNoEInYourName() {
         ...
         */
        nameCollection.removeIf(name -> name.contains("e"));
    ...
    public void replaceTheElements() {
         ...
         */
        nameList.replaceAll(name -> String.format("(%s)",name));
    ...
    public void sortByName() {
        ...
        Collections.sort(nameList, Comparator.comparingInt(name -> name.length()));
